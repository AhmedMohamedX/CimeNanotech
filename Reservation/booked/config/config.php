...
$conf['settings']['app.title'] = 'Scheduler Conception';
$conf['settings']['default.timezone'] = 'Europe/Paris';
$conf['settings']['allow.self.registration'] = 'true';
$conf['settings']['admin.email'] = 'mohamed.benjrad@grenoble-inp.fr';
...
$conf['settings']['script.url'] = 'http://localhost/CimeNanotech/Reservation/booked';
...
$conf['settings']['reservation']['start.time.constraint'] = 'today';
...
$conf['settings']['database']['password'] = 'cime11';
...
$conf['settings']['install.password'] = 'cime11';
